...
{
    [SerializeField]
    private int minRoomWidth = 4, minRoomHeigh = 4;
    [SerializeField]
    ...
    private void CreateRooms()
    {
        var roomsList = ProceduralGenerationAlgorithms.BinarySpacePartitioning(new BoundsInt((Vector3Int)startPosition, new Vector3Int
            (dungeonWidth, dungeonHeight, 0)), minRoomWidth, minRoomHeigh);
    ...
    private HashSet<Vector2Int> ConnectRooms(List<Vector2Int> roomsCenters)
    {
        ...
        var currentRoomCenter = roomsCenters[UnityEngine.Random.Range(0, roomsCenters.Count)];
